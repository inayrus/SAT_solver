"""
Trivial script ripped from Plankje <3 xoxo
(https://github.com/ehmPlankje/sat-solver/blob/master/encode-sudoku.py)
"""
...
def main(sudoku_filename: str, output_directory: str, output_prefix: str) -> None:
    ...
    for i, sudoku in enumerate(input_file):
        ...
        # we did edit this tho xoxo
        # open sudoku rules
        rules_file = open("sudoku-rules.txt", "r")
